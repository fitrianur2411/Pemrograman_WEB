...
<html>
    ...
    <body>
        <div class="container mt-4">
            ...
            // Query untuk memilih semua data anggota dari tabel anggota dan mengurutkannya berdasarkan id secara descending
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    while($row = mysqli_fetch_assoc($result)){ // looping untuk menampilkan data anggota
